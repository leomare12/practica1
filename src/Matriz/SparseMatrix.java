 ...
 * @file Sparse matrix.
 *
 *       Implementation with singly linked list, through the nested class
 *       SparseMatrixNode. It's used nested class to improve encapsulation.
 *
...
public class SparseMatrix {
	 ...
	 * matrix.
	 *
	 * @param int x Horizontal coordenate.
	 * @param int y Vertical coordenate.
	 * @return SparseMatrixNode | null Element founded or null, if not founded.
	 */
	 ...
	 *
	 * Search the previous of the element with coordenates "x" and "y" in the sparse
	 * matrix.
	 *
	 * @param int x Horizontal coordenate.
	 * @param int y Vertical coordenate.
	 * @return SparseMatrixNode | null The return of this method must be interpreted
	 *         together with search() method. The method returns or the real
	 *         previous of the element with the coordenates, if element exists, or
	 *         returns the intended previous of the element, if it is not present in
	 *         the sparse matrix, in order to be used to insert the element after
	 *         the previous returned by this method.
	 */
	 ...
	 * @param int x Horizontal coordenate.
	 * @param int y Vertical coordenate.
	 * @return int Element key or -5 if there is not element with these coordenates.
	 */
	 ...
	 * Full method.
	 *
	 * Determines if the sparse matrix is full, i.e., if all coordenates of matrix
	 ...
	 * matrix.
	 *
	 * @return String Representation of the sparse matrix in the moment by a string.
	 */
	public String toString() {
		...
		description += "# Elementos: " + this.number_of_elements + " \n ";
